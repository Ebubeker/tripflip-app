...
const AddFlightModal = ({ tripId, show, setShow, refetch }: AddFlightModalProps) => {
  ...
  const onSubmit = (data: FlightFormData) => {
    ...
    insertFlight(tripId, formattedData.flightNumber, formattedData.price, formattedData.from_location, formattedData.to_location, formattedData.departure_date, formattedData.arrival_date).then((data)=> {
      console.log(data)
    }).catch((error) => {
          ...
          render={({ field: { onChange, value } }) => (
            <TextInput
              ...
              style={{
                ...
                borderColor: errors.flightNumber ? "red" : "rgba(0,0,0,0.2)",
              }}
            ...
            <View>
              <TextInput
                ...
                style={{
                  ...
                  paddingTop: Platform.OS === "ios" ? 8 : 12,
                  lineHeight: Platform.OS === "ios" ? 20 : undefined,
                  borderColor: errors.fromAirport ? "red" : "rgba(0,0,0,0.2)",
                }}
